...
//    libraryDescription = 'An Android library to help create background drawable and ColorStateList without xml'
...
EasyPublish {
    ...
    description = 'An Android library to help create background drawable and ColorStateList without xml'
    developer {
        id = 'leobert'
        name = 'leobert'
